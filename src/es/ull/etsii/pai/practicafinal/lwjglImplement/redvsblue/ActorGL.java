...
public class ActorGL extends Entity {
	...
	public ArrayList<GLRectangle> getGraphicShapes() {
		return graphicShapes;
	}
	public void setGraphicShapes(ArrayList<GLRectangle> graphicShapes) {
